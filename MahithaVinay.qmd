...
fig.show()
```
Average Observations of ARDs among children under 5 display diverse trends across different countries, indicating significant variability in ARD prevalence globally. The first takeaway from this graph is the infection rates across the countries. We can classify them as follows - 
